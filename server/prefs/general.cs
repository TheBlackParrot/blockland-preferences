function registerServerSettingPrefs() {
	...
	registerPref(%cat, "Security", "Auto Super Admin IDs", "userlist", "$Pref::Server::AutoSuperAdminList", $Pref::Server::AutoSuperAdminList, "_ -1", "updateBLPrefPermission", 0, 0, 0);
	...
	registerPref(%cat, "Gameplay", "Maximum Bricks", "number", "$Pref::Server::BrickLimit", $Pref::Server::BrickLimit, "1 1000000 0", "updateServerSetting", 0);
